...
Do not proceed further until Anudeep pastes the transcript.

---

## Phase 5: After Transcript (runs when Anudeep pastes the meeting transcript)

When Anudeep pastes the transcript:
...
3. Before writing anything, output a plain-English summary of every change you intend to make:
   ...
   Wait for Anudeep to confirm before proceeding to step 4.
...
5. Ask Anudeep clarifying questions one at a time until you are fully confident that every story is understood well enough to be delivered — no cap on questions, keep asking until there are zero remaining unknowns
