...
**First:** Read `/Users/anudeepsharma/Programming/DevOS/tasks/lessons.md` to find the project's test configuration. If `lessons.md` does not exist, read `/Users/anudeepsharma/Programming/DevOS/tasks/notes.md` instead — solo projects store the same test commands there under the "Test Commands" section. All commands come from one of these two files — nothing is hardcoded.
...
3. **Print the URL** — tell Anudeep the localhost URL to open in a browser
4. **Stay running** — does NOT auto-stop. Anudeep closes it when done.
...
cd /Users/anudeepsharma/Programming/DevOS && <custom-test-script> <level>
```
...
```bash
# Level 1
cd /Users/anudeepsharma/Programming/DevOS && <build command>
cd /Users/anudeepsharma/Programming/DevOS && <unit test command>

# Level 2 (additional)
cd /Users/anudeepsharma/Programming/DevOS && <setup command>  # if defined (e.g., docker compose up -d)
cd /Users/anudeepsharma/Programming/DevOS && <integration test command>
cd /Users/anudeepsharma/Programming/DevOS && <cleanup command>  # if defined (e.g., docker compose down)

# Level 3 (additional)
cd /Users/anudeepsharma/Programming/DevOS && <dev server command>  # stays running
```
...
If any step fails:
1. Show the exact error output to Anudeep
