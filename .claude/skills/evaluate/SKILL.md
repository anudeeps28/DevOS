...
Run:
```bash
cd /Users/anudeepsharma/Programming/DevOS && git branch --show-current && git diff --stat HEAD~1..HEAD
```
...
```bash
ls /Users/anudeepsharma/Programming/DevOS/tasks/stories/[story-id]/plan.md 2>/dev/null || echo "no plan"
```
