...
The user's harness source repo is at `https://github.com/anudeeps28/claude-code-harness` (set during install — wherever they cloned `claude-code-harness`). Your proposals reference files in that repo. The user applies the changes manually.
...
```
Wrote tasks/improve-harness-<date>.md with <P> proposals. Review and apply to the harness repo at https://github.com/anudeeps28/claude-code-harness.
```
...
- **Don't edit any file in the harness repo at `https://github.com/anudeeps28/claude-code-harness`.** Your output is the proposal file; the user applies changes themselves.
