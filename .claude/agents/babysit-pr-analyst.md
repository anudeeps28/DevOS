...
- File paths from ADO are repo-relative with forward slashes (e.g. `/src/DevOSSPACE.API/Controllers/QueryController.cs`)
- Convert to absolute Windows path: prepend `/Users/anudeepsharma/Programming/DevOS` and convert `/` to `\`
...
- File: `src/DevOSSPACE.Domain/Entities/Document.cs`
