...
- Base path: `/Users/anudeepsharma/Programming/DevOS\`
...
Read `/Users/anudeepsharma/Programming/DevOS/tasks/lessons.md` — the "Code Conventions" section lists naming patterns, logging rules, dependency management, and other project-specific conventions. Follow them exactly. If `lessons.md` doesn't have a conventions section, follow the conventions visible in the existing files you read in Step 1.
...
```bash
cd /Users/anudeepsharma/Programming/DevOS && <verify command>
```
...
- Do NOT reference absolute paths outside `/Users/anudeepsharma/Programming/DevOS` — they may not exist in the worktree