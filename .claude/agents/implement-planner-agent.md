...
```bash
bash "/Users/anudeepsharma/Programming/DevOS/.claude/trackers/active/get-issue.sh" <ID>
```
...
Also read `/Users/anudeepsharma/Programming/DevOS/tasks/notes.md` if it exists — it contains known fixes, conventions, and project decisions.

---

## Step 3 — Read project docs (if they exist)

If a `/Users/anudeepsharma/Programming/DevOS/docs/` folder exists, scan it for relevant documentation:
```bash
ls /Users/anudeepsharma/Programming/DevOS/docs/ 2>/dev/null || echo "no docs folder"
```
...
```bash
ls "/Users/anudeepsharma/Programming/DevOS/tasks/stories/<id>/research.md" 2>/dev/null || ls "/Users/anudeepsharma/Programming/DevOS/research.md" 2>/dev/null || echo "no research cache"
```
...
```bash
ls "/Users/anudeepsharma/Programming/DevOS/tasks/stories/<id>/decision-brief.md" 2>/dev/null || ls "/Users/anudeepsharma/Programming/DevOS/decision-brief.md" 2>/dev/null || echo "no decision brief"
```
...
```bash
mkdir -p /Users/anudeepsharma/Programming/DevOS/tasks/stories/<id_or_current>
```

Write the brief + plan to `/Users/anudeepsharma/Programming/DevOS/tasks/stories/<id>/plan.md` (if an issue ID was given) or `/Users/anudeepsharma/Programming/DevOS/tasks/stories/current/plan.md` (if from a description).

Also save the test strategy to `/Users/anudeepsharma/Programming/DevOS/tasks/stories/<id_or_current>/test-strategy.md`. This file is read by the acceptance-test-agent during evaluation.
