...
You produce an 8-point pre-planning brief for a DevOS sprint story. You will be given a story ID and a sprint file path.
...
```bash
bash "/Users/anudeepsharma/Programming/DevOS/.claude/trackers/active/get-issue.sh" <STORY_ID>
bash "/Users/anudeepsharma/Programming/DevOS/.claude/trackers/active/get-issue-children.sh" <STORY_ID>
```
...
|---|---|
| API endpoints, controllers, request/response shapes | `/Users/anudeepsharma/Programming/DevOS\docs\API_REFERENCE.md` |
| Database tables, columns, EF migrations, entities | `/Users/anudeepsharma/Programming/DevOS\docs\DATABASE_SCHEMA.md` |
| Template JSON, extraction rules, LLM, field generation | `/Users/anudeepsharma/Programming/DevOS\docs\TEMPLATE_SCHEMA.md` |
| System design, data flows, architecture decisions, cost | `/Users/anudeepsharma/Programming/DevOS\docs\ARCHITECTURE.md` |
| Coding standards, logging patterns, testing conventions | `/Users/anudeepsharma/Programming/DevOS\docs\DEVELOPMENT_GUIDE.md` |
| Template review workflow, approval/rejection queue | `/Users/anudeepsharma/Programming/DevOS\docs\TEMPLATE_REVIEW_WORKFLOW.md` |
| Deployment, CI/CD, Azure container setup | `/Users/anudeepsharma/Programming/DevOS\docs\DEPLOYMENT.md` |
| Known issues, error messages, diagnostic commands | `/Users/anudeepsharma/Programming/DevOS\docs\TROUBLESHOOTING.md` |
...
Common locations:
- Controllers: `src/DevOSSPACE.API/Controllers/*.cs`
- DTOs: `src/DevOSSPACE.Application/DTOs/*.cs`
- Interfaces: `src/DevOSSPACE.Application/Interfaces/*.cs`
- Infrastructure services: `src/DevOSSPACE.Infrastructure/Services/*.cs`
- Domain entities: `src/DevOSSPACE.Domain/Entities/*.cs`
- Parsing: `src/DevOSSPACE.Parsing/**/*.cs`
- Azure Functions: `src/DevOSSPACE.Functions/**/*.cs`
...
```bash
ls "/Users/anudeepsharma/Programming/DevOS/tasks/stories/<STORY_ID>/decision-brief.md" 2>/dev/null || echo "no decision brief"
```
...
```bash
ls "/Users/anudeepsharma/Programming/DevOS/decision-brief.md" 2>/dev/null || echo "no root decision brief"
```
...
```bash
ls "/Users/anudeepsharma/Programming/DevOS/tasks/stories/<STORY_ID>/research.md" 2>/dev/null || ls "/Users/anudeepsharma/Programming/DevOS/research.md" 2>/dev/null || echo "no research cache"
```
...
Run:
```bash
cd /Users/anudeepsharma/Programming/DevOS && git status && git log --oneline -5
```
